  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .scapia-strip{align-items:center;background:var(--cream);border-bottom:1px solid #eadfd3;display:flex;gap:clamp(24px,5vw,76px);justify-center:center;min-height:68px;padding:14px 32px}.scapia-strip p{color:#443b45;font-size:12px;font-weight:700;margin:0}.scapia-strip span{color:var(--coral);margin-right:7px}
