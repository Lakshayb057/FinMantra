  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        @import url('https://fonts.googleapis.com/css2?family=Hanken+Grotesk:wght@400;500;600;700;800;900&family=Geist:wght@400;500;600;700&family=Inter:wght@400;500;600;700;800&display=swap');
        ...
        .scapia-body{margin:0;background:var(--mist);color:var(--ink);font-family:'Hanken Grotesk','Geist Sans',Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;-webkit-font-smoothing:antialiased}
        ...
        .scapia-section{padding:96px max(24px,calc((100vw - 1180px)/2));text-align:center}.scapia-kicker{color:#a13f39;font-family:ui-monospace,monospace;font-size:11px;letter-spacing:.22em;margin:0;font-weight:700}.scapia-section h2,.scapia-steps h2,.scapia-faq h2{font-size:clamp(40px,5vw,64px);letter-spacing:-.06em;line-height:.98;margin:15px 0 18px}.scapia-section h2 em,.scapia-faq h2 em{color:var(--coral);font-family:Georgia,serif;font-weight:400}.scapia-section>.scapia-lead{color:var(--muted);font-size:17px;margin:0 auto;max-width:560px}.scapia-features{display:grid;gap:16px;grid-template-columns:repeat(4,1fr);margin-top:50px;text-align:left}.scapia-features article{background:#fff;border:1px solid var(--line);border-radius:20px;min-height:260px;padding:26px;transition:all 0.3s cubic-bezier(0.16,1,0.3,1)}.scapia-features article:hover{transform:translateY(-6px);box-shadow:0 18px 40px rgba(17,27,46,.08);border-color:#cbd5e1}.scapia-mark{align-items:center;background:#fff0eb;border-radius:12px;color:var(--coral);display:inline-flex;font-family:ui-monospace,monospace;font-weight:800;height:44px;justify-content:center;min-width:44px;padding:0 10px}.scapia-features h3{font-size:20px;letter-spacing:-.03em;line-height:1.15;margin:20px 0 10px;font-weight:800}.scapia-features p{color:var(--muted);font-size:14px;line-height:1.55;margin:0}
        .scapia-stories{background:#fff9f3;border-block:1px solid #eadfd4;padding:96px max(24px,calc((100vw - 1180px)/2));text-align:left}.scapia-stories-head{align-items:end;display:grid;gap:50px;grid-template-columns:1.2fr .8fr}.scapia-stories h2{font-size:clamp(40px,5vw,62px);letter-spacing:-.06em;line-height:.98;margin:14px 0 0;font-weight:800}.scapia-stories h2 em{color:var(--coral);font-family:Georgia,serif;font-weight:400}.scapia-stories-head>p{color:var(--muted);font-size:16px;line-height:1.6;margin:0}.scapia-story-grid{display:grid;gap:16px;grid-template-columns:repeat(3,1fr);margin-top:40px}.scapia-story{background:linear-gradient(150deg,#201641,#4e2d71 62%,#b84c61);border-radius:20px;color:var(--cream);min-height:300px;overflow:hidden;padding:28px;position:relative;transition:all 0.3s ease}.scapia-story:hover{transform:translateY(-5px);box-shadow:0 20px 50px rgba(32,22,65,.35)}.scapia-story:after{border-top:2px dashed rgba(255,220,194,.65);border-radius:50%;content:"";height:130px;left:-20px;position:absolute;top:88px;transform:rotate(-14deg);width:115%}.scapia-story small{color:#ffd5c0;font-family:ui-monospace,monospace;letter-spacing:.13em;font-weight:700}.scapia-story h3{font-size:40px;letter-spacing:-.06em;line-height:.94;margin:80px 0 10px;position:relative;z-index:2;font-weight:800}.scapia-story h3 span{color:var(--salmon)}.scapia-story p{color:#eadde4;font-size:13px;margin:0;position:relative;z-index:2}
        .scapia-steps{background:linear-gradient(145deg,#171036,#2d1c5c 65%,#4e2b6b);color:var(--cream);padding:100px max(24px,calc((100vw - 1180px)/2))}.scapia-light{color:#ffc6a8}.scapia-steps-grid{display:grid;gap:16px;grid-template-columns:repeat(3,1fr);margin-top:44px}.scapia-steps-grid article{background:rgba(255,255,255,.055);border:1px solid rgba(255,255,255,.16);border-radius:20px;padding:28px;backdrop-filter:blur(8px);transition:all 0.3s ease}.scapia-steps-grid article:hover{background:rgba(255,255,255,.1);transform:translateY(-4px)}.scapia-steps-grid article>span{color:var(--peach);font-family:ui-monospace,monospace;font-size:12px;letter-spacing:.15em;font-weight:800}.scapia-steps-grid h3{font-size:21px;margin:28px 0 8px;font-weight:800}.scapia-steps-grid p{color:#d9cedd;font-size:14px;line-height:1.55;margin:0}.scapia-steps .scapia-button{background:var(--coral);border-radius:99px;color:var(--night);display:inline-flex;font-weight:800;margin-top:34px;padding:15px 23px;transition:all 0.25s ease;box-shadow:0 4px 16px rgba(255,91,77,.35)}.scapia-steps .scapia-button:hover{transform:translateY(-2px);box-shadow:0 8px 24px rgba(255,91,77,.5)}
        .scapia-faq{background:#fff;display:grid;gap:80px;grid-template-columns:.72fr 1.28fr;padding:100px max(24px,calc((100vw - 1180px)/2))}.scapia-faq-heading{align-self:start;position:sticky;top:100px}.scapia-faq-list details{border-bottom:1px solid var(--line)}.scapia-faq-list details:first-child{border-top:1px solid var(--line)}.scapia-faq summary{cursor:pointer;font-size:17px;font-weight:750;list-style:none;padding:23px 38px 23px 0;position:relative;transition:color 0.2s ease}.scapia-faq summary:hover{color:var(--coral)}.scapia-faq summary::-webkit-details-marker{display:none}.scapia-faq summary:after{color:var(--coral);content:"+";font-size:24px;position:absolute;right:5px;top:17px}.scapia-faq details[open] summary:after{content:"\u2013"}.scapia-faq details p{color:var(--muted);font-size:14px;line-height:1.65;margin:-5px 0 24px;padding-right:25px}
